...
uex  = @(x,y) exp(-1000*(x-0.5).^2-1000*(y-0.5).^2)+sin(pi*x);   %Analytical solution
uexx = @(x,y) 2000*(x-0.5).*(1000*(x-0.5).^2+1000*(y-0.5).^2).*exp(-1000*(x-0.5).^2-1000*(y-0.5).^2)+pi*cos(pi*x);   %Gradient Analytical solution (x)
uexy = @(x,y) 2000*(y-0.5).*(1000*(x-0.5).^2+1000*(y-0.5).^2).*exp(-1000*(x-0.5).^2-1000*(y-0.5).^2);   %Gradient Analytical solution (y)
ff   = @(x,y) 4000*exp(-1000*(x-0.5).^2-1000*(y-0.5).^2)-4000000*exp(-1000*(x-0.5).^2-1000*(y-0.5).^2).*((x-0.5).^2+(y-0.5).^2)+pi^2*sin(pi*x);   %Forcing term
...
for nex = [2 4 8 16 18 20]                 %[2,4,8,10,12,14,16,18,20];
    ...
    for nx = [1 2 3 4 5]                  %[2,4,8,10,12,14,16,18,20];
                             % polynomial degree in each element along x-direction
