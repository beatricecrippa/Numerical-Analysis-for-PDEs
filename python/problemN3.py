# -*- coding: utf-8 -*-
"""
Created on Fri Jan  8 15:18:16 2021
...
for dim in [5]:			 #loop on different dimensions
    ...
    for layer in layers:
        #print(layer)
        npde = HighDimensionSingularity(64, layer, dim) # batch-size, number of layers, dimension
        rbloss = []
        rloss = []
        rl2 = []
